    ...
    Honesthash.prototype.hashHex = function(wannaBeHashed) {
        ...
        console.log("time is >", this._endtime - this._startime, "ms");

        console.log("result >", hashedAgainInLoop);

    };


    var hashThisShit = new Honesthash({
        hash : "938839798378937a3893",
        speed : 30000
    });


    hashThisShit.hashHex("aaads mkladm klasdm lkasdml asmkds");